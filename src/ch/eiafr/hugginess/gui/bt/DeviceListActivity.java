...
package ch.eiafr.hugginess.gui.bt;
...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int listId = getIntent().getIntExtra("layout_list", R.layout.activity_devicelist );
        ...
        int layout_text = getIntent().getIntExtra("layout_text", R.layout.adapter_devicelist_item );
