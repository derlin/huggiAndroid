...
import static ch.eiafr.hugginess.services.bluetooth.BluetoothConstants.EXTRA_DEVICE_ADDRESS;
import static ch.eiafr.hugginess.services.bluetooth.BluetoothConstants.REQUEST_CONNECT_DEVICE;
...
//            findViewById( R.id.manage_pref_header ).setEnabled( false );
    ...
    protected boolean isValidFragment(String fragmentName) {
        return "ch.eiafr.hugginess.gui.prefs.frag.ManageShirtPrefFragment".equals( fragmentName ) ||
         "ch.eiafr.hugginess.gui.prefs.PrefsActivity$PrefsFragment".equals( fragmentName );
    }
    //-------------------------------------------------------------
    ...
    public static class PrefsFragment extends PreferenceFragment{
        ...
        public void onCreate( Bundle savedInstanceState ){
            ...
            addPreferencesFromResource( R.xml.activity_pref_frag_core );
